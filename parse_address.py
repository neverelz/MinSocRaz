import pandas as pd
import re
# в столбце TOWN исправить случаи если "пос.", продумать логику дла автоматизации
...
# для определения сходести названий столбцов пробовала fasttext, не хочет видеть wheel, поэтому отказалась
